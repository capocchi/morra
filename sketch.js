...
function handleStartStop() {
  ...
  if (jeuEnCours) {
    ...
    phaseJeu = "ATTENTE";
    messageAction = "JEU ARRÊTÉ. Touchez ou ESPACE pour reprendre.";
    messageResultat = "";
...
function displayUI(mesDoigts) {
    ...
    fill(255, 150);
    textSize(14);
    let controlText = isMobile ? "Touchez l'écran" : "Espace";
    text("Doigts : " + mesDoigts + " | " + controlText + " pour ON/OFF", 40, height - 30);
